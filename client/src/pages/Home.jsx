      ...
      {faqs.length > 0 && (
        <section className="w-full max-w-xl px-6 py-8 md:py-12">
          <div className="text-center mb-6">
             ...
             <p className="text-slate-400 font-medium text-[10px] uppercase tracking-widest">{t('home.faq_subtitle') || "Essential guidance for Baba Shyam Devotees"}</p>
          </div>
                     ...
                     <AnimatePresence>
                        {openFaq === idx && (
                           <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.3 }}>
                              <div className="p-5 pt-0 text-slate-600 text-xs sm:text-sm font-medium leading-relaxed border-t border-orange-50/50 pt-4 bg-orange-50/10">"{answerText}"</div>
                           </motion.div>
                        )}
                     </AnimatePresence>
                  </div>
