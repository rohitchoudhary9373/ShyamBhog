    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-10 space-y-12">
      <header className="bg-slate-900 rounded-2xl p-6 md:p-8 text-white shadow-xl flex flex-col md:flex-row justify-between md:items-end gap-6">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          <input 
            type="date" 
            className="bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-orange-500 w-full sm:w-auto text-white placeholder-slate-400"
          />
          <select 
            className="bg-slate-800 border border-slate-700 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-orange-500 text-white w-full sm:w-auto"
          >
