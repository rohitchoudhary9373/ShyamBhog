    ...
    <div className="max-w-7xl animate-fade-in pb-20">
      ...
      <section className="mb-20">
        <header className="mb-10">
          <h1 className="text-4xl font-black text-slate-900 tracking-tighter">Manage Parking Locations</h1>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-12">
          ...
          <div className="xl:col-span-1">
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-[48px] border-2 border-slate-100 shadow-sm space-y-5 sticky top-24">
               <h2 className="text-xl font-black text-slate-900 flex items-center gap-2 mb-4">Add Parking Spot</h2>
               ...
               <div className="space-y-1">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Google Maps URL</label>
               ...
               <button type="submit" disabled={saving} className="w-full py-4 bg-blue-600 text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl shadow-blue-100 hover:bg-slate-900 transition-all">
          ...
          <div className="xl:col-span-2 space-y-6">
             {spots.map(spot => (
               <div key={spot._id} className="bg-white p-6 rounded-[40px] border-2 border-slate-100 shadow-sm flex flex-col md:flex-row gap-6 items-center">
                  ...
                  <div className="flex-grow text-center md:text-left">
                     <div className="flex items-center justify-center md:justify-start gap-3">
                        <h3 className="text-lg font-black text-slate-900">{spot.name}</h3>
                     ...
                     <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                        <span className="bg-slate-50 text-slate-600 text-[10px] font-black px-2 py-0.5 rounded-md flex items-center gap-1">
                           <FaWalking /> {spot.distanceFromTemple}
                        </span>
                        <a href={spot.googleMapsUrl} target="_blank" rel="noreferrer" className="bg-blue-50 text-blue-600 text-[10px] font-black px-2 py-0.5 rounded-md flex items-center gap-1">
                           <FaLink /> Google Maps
                        </a>
                     </div>
                  </div>
      ...
      <section className="mt-20 pt-20 border-t-2 border-slate-100">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
               <form onSubmit={handleFaqSubmit} className="bg-slate-900 p-8 rounded-[40px] shadow-2xl text-white space-y-5">
                  <h3 className="text-lg font-black mb-4">Add Parking FAQ</h3>
                  <div className="space-y-1">
                     <label className="text-[10px] font-black text-white/40 uppercase tracking-widest px-1">Devotee Question</label>
                  ...
                  <div className="space-y-1">
                     <label className="text-[10px] font-black text-white/40 uppercase tracking-widest px-1">Detailed Answer</label>
                  ...
                  <button type="submit" className="w-full py-4 bg-blue-600 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-white hover:text-slate-900 transition-all shadow-xl shadow-blue-900/20">
                     Publish FAQ
                  </button>
               </form>
            </div>
            ...
            <div className="lg:col-span-2 space-y-4">
               {faqs.map(faq => (
                  <div key={faq._id} className="bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm flex items-start gap-4 group">
                     <div className="w-10 h-10 rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center shrink-0 font-black">?</div>
                     <div className="flex-grow">
                        <h4 className="font-black text-slate-900 text-sm mb-1">{faq.question}</h4>
               ...
               {faqs.length === 0 && (
                  <div className="text-center py-20 bg-slate-50 rounded-[40px] border-2 border-dashed border-slate-100">
                     <p className="text-slate-400 font-black uppercase tracking-widest text-[10px]">No FAQs added for Parking yet.</p>
                  </div>
               )}
            </div>
         </div>
