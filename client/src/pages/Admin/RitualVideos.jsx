  ...
  return (
    <div className="max-w-6xl animate-fade-in">
      <header className="mb-10">
        <h1 className="text-4xl font-black text-slate-900 tracking-tighter">Ritual Proof Management</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-1">
          <form onSubmit={handleSubmit} className="bg-white p-8 rounded-[40px] border border-slate-100 shadow-sm space-y-6 sticky top-24">
            ...
            <div className="space-y-1">
               <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Proof Title</label>
            ...
            <div className="space-y-1">
               <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Ritual Category</label>
            ...
            <div className="space-y-1">
               <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Video File (Direct Upload)</label>
               <div className="relative group/upload">
                  ...
                  <label 
                    ...
                    className="w-full p-8 border-2 border-dashed border-slate-200 rounded-2xl flex flex-col items-center justify-center gap-3 cursor-pointer hover:border-primary hover:bg-orange-50 transition-all group"
                  >
            ...
            <button type="submit" disabled={saving || !videoFile} className="w-full py-4 bg-primary text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-900 transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed">
           ...
           {loading ? (
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {videos.map(vid => {
                   ...
                   return (
                   <div key={vid._id} className="bg-white rounded-[40px] border border-slate-100 overflow-hidden shadow-sm group">
                      <div className="aspect-video bg-slate-900 relative flex items-center justify-center">
                         ...
                         <span className="absolute top-4 left-4 bg-white/10 backdrop-blur-md text-white text-[10px] font-black uppercase px-3 py-1 rounded-full border border-white/20 tracking-widest">
                            {vid.category}
                         </span>
                      </div>
                      <div className="p-6 flex justify-between items-start">
                         <div>
                            <h3 className="text-lg font-black text-slate-900 line-clamp-1">{vid.title}</h3>
                ...
                {videos.length === 0 && (
                   <div className="col-span-2 p-20 text-center bg-slate-50 rounded-[40px] border-2 border-dashed border-slate-200">
