   ...
   return (
      <div className="min-h-[100dvh] bg-[#FDF8F1] pb-24 font-sans animate-fade-in">
         ...
         <AnimatePresence>
            {isEditing && (
               <div className="fixed inset-0 z-[100] bg-slate-900/60 backdrop-blur-md flex items-center justify-center p-4">
                  <motion.div initial={{ y: 50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ y: 50, opacity: 0 }} className="bg-white w-full max-w-xl max-h-[90vh] overflow-y-auto overflow-x-hidden no-scrollbar rounded-[48px] p-6 md:p-12 shadow-2xl relative">
